...
vegetables <- list("Water spinach", "Tomato", "Eggplant", "Squash", "Moringa leaves", "String beans", "Bitter gourd", "Lady finger", "Taro", "Bok choy")
vegetables
```
```{r}
...
vegetables
datapoints <- length(vegetables)
print(paste("There are ", datapoints, "vegetables in my Vegetable list"))
```
